                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" value={adminProfileData.nombre} onChange={e => setAdminProfileData({...adminProfileData, nombre: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-sm outline-none focus:border-emerald-500 dark:text-white" placeholder="Tu nombre"/>
                                    </div>
                                    <div>
                                        <label className="text-xs text-zinc-500 block mb-1 font-bold">Apellidos</label>
                                        <input type="text" value={adminProfileData.apellidos} onChange={e => setAdminProfileData({...adminProfileData, apellidos: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-sm outline-none focus:border-emerald-500 dark:text-white" placeholder="Tus apellidos"/>
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="password" value={adminProfileData.newPassword} onChange={e => setAdminProfileData({...adminProfileData, newPassword: e.target.value})} placeholder="Dejar en blanco para no cambiar" className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 text-sm outline-none focus:border-emerald-500 dark:text-white" />
                                    </div>
                                </div>
                        ...
                        <form onSubmit={handleCreateComercial} className="space-y-5 bg-white dark:bg-zinc-950 p-4 rounded-xl border border-indigo-100 dark:border-indigo-900/30">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input required type="text" value={comercialData.nombre} onChange={e => setComercialData({...comercialData, nombre: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-900 border border-indigo-200 dark:border-indigo-800/50 rounded-lg px-3 py-2 text-sm outline-none focus:border-indigo-500 dark:text-white" placeholder="Nombre"/>
                                </div>
                                <div>
                                    <label className="text-xs text-indigo-900/70 dark:text-indigo-300 block mb-1 font-bold">Apellidos</label>
                                    <input required type="text" value={comercialData.apellidos} onChange={e => setComercialData({...comercialData, apellidos: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-900 border border-indigo-200 dark:border-indigo-800/50 rounded-lg px-3 py-2 text-sm outline-none focus:border-indigo-500 dark:text-white" placeholder="Apellidos"/>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input required type="email" value={comercialData.email} onChange={e => setComercialData({...comercialData, email: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-900 border border-indigo-200 dark:border-indigo-800/50 rounded-lg px-3 py-2 text-sm outline-none focus:border-indigo-500 dark:text-white" placeholder="comercial@fotoesport.com"/>
                                </div>
                                <div>
                                    <label className="text-xs text-indigo-900/70 dark:text-indigo-300 block mb-1 font-bold">Contraseña Temporal</label>
                                    <input required type="password" value={comercialData.password} onChange={e => setComercialData({...comercialData, password: e.target.value})} className="w-full bg-zinc-50 dark:bg-zinc-900 border border-indigo-200 dark:border-indigo-800/50 rounded-lg px-3 py-2 text-sm outline-none focus:border-indigo-500 dark:text-white" placeholder="Mínimo 6 caracteres"/>
                                </div>
                            </div>
                                    ...
                                    <div key={member.id} className="bg-white dark:bg-zinc-950 border border-indigo-100 dark:border-indigo-900/30 p-4 rounded-xl shadow-sm">
                                        {editingUser === member.id ? (
                                            <form onSubmit={(e) => handleUpdateUser(e, member.id)} className="space-y-4">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    <input type="text" placeholder="Nombre" value={editUserData.nombre} onChange={e => setEditUserData({...editUserData, nombre: e.target.value})} className="w-full text-sm px-3 py-2 border rounded-lg outline-none focus:border-indigo-500 bg-zinc-50 dark:bg-zinc-900 dark:border-zinc-800 dark:text-white"/>
                                                    <input type="text" placeholder="Apellidos" value={editUserData.apellidos} onChange={e => setEditUserData({...editUserData, apellidos: e.target.value})} className="w-full text-sm px-3 py-2 border rounded-lg outline-none focus:border-indigo-500 bg-zinc-50 dark:bg-zinc-900 dark:border-zinc-800 dark:text-white"/>
                                                </div>

                                                <input type="password" placeholder="Nueva contraseña (opcional)" value={editUserData.password} onChange={e => setEditUserData({...editUserData, password: e.target.value})} className="w-full text-sm px-3 py-2 border rounded-lg outline-none focus:border-indigo-500 bg-zinc-50 dark:bg-zinc-900 dark:border-zinc-800 dark:text-white"/>
                                                ...
                                                <div className="grid grid-cols-1 gap-2 pt-2 border-t border-zinc-100 dark:border-zinc-800">
                                                    <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" checked={editUserData.permissions?.canEditSeasons || false} onChange={e => setEditUserData({...editUserData, permissions: {...editUserData.permissions, canEditSeasons: e.target.checked}})} className="w-4 h-4"/> <span className="text-xs dark:text-zinc-300">Permiso: Temporadas</span></label>
                                                    <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" checked={editUserData.permissions?.canEditChecklist || false} onChange={e => setEditUserData({...editUserData, permissions: {...editUserData.permissions, canEditChecklist: e.target.checked}})} className="w-4 h-4"/> <span className="text-xs dark:text-zinc-300">Permiso: Checklist</span></label>
                                                    <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" checked={editUserData.permissions?.canEditObjectives || false} onChange={e => setEditUserData({...editUserData, permissions: {...editUserData.permissions, canEditObjectives: e.target.checked}})} className="w-4 h-4"/> <span className="text-xs dark:text-zinc-300">Permiso: Finanzas</span></label>
                                                </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800">
                                ...
                                {googleEmail ? <Button variant="outline" size="sm" onClick={() => setGoogleEmail(null)} className="border-red-200 text-red-600 hover:bg-red-50">Desvincular</Button> : <div className="scale-90 origin-right"><GoogleLogin 
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    prompt="consent" // <--- CAMBIA ESTO (antes tenías select_account)
                                                                                                                                                                                                                                                    auto_select={false} 
                                                                                                                                                                                                                                                    useOneTap={false} // <--- AÑADE ESTO para desactivar el inicio automático agresivo
                                                                                                                                                                                                                                                    shape="rectangular" 
                                                                                                                                                                                                                                                /></div>}
                            </div>
                            <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:items-end">
                            <div className="flex-1"><label className="text-xs block mb-1 font-bold dark:text-zinc-300">Meta Clubes</label><input type="number" className="w-full bg-zinc-50 border rounded-lg px-3 py-2 text-sm outline-none focus:border-emerald-500 dark:bg-zinc-900 dark:border-zinc-800 dark:text-white" value={localTarget} onChange={(e) => setLocalTarget(e.target.value)}/></div>
                            <div className="flex-1"><label className="text-xs block mb-1 font-bold dark:text-zinc-300">Ticket Medio (€)</label><input type="number" className="w-full bg-zinc-50 border rounded-lg px-3 py-2 text-sm outline-none focus:border-emerald-500 dark:bg-zinc-900 dark:border-zinc-800 dark:text-white" value={localTicket} onChange={(e) => setLocalTicket(e.target.value)}/></div>
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
                        ...
                        <div className="border border-zinc-200 rounded-lg overflow-hidden dark:border-zinc-800">
                                    ...
                                    <div key={season} className="flex items-center justify-between p-3 border-b last:border-0 dark:border-zinc-800">
                                        {editingSeason === season ? (
                                            <div className="flex flex-1 gap-2 mr-2">
                                                <input autoFocus value={editInput} onChange={e => setEditInput(e.target.value)} className="flex-1 text-sm px-2 py-1 border rounded dark:bg-zinc-900 dark:border-zinc-800 dark:text-white outline-none focus:border-emerald-500" />
                                            ...
                                            <>
                                                <div className="flex items-center gap-2"><span className="text-sm font-bold dark:text-white">{season}</span>{activeSeason === season && <span className="text-[10px] bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded uppercase font-bold">Oficial</span>}</div>
                                                <div className="flex gap-1">
                                                    <button onClick={() => onExportSeason(season)} className="p-1.5 text-zinc-500 hover:bg-blue-50 rounded-md dark:hover:bg-blue-900/50"><Download className="w-4 h-4"/></button>
                                                    <button onClick={() => { setEditingSeason(season); setEditInput(season); }} className="p-1.5 text-zinc-500 hover:bg-amber-50 rounded-md dark:hover:bg-amber-900/50"><Edit2 className="w-4 h-4"/></button>
                                                    <button onClick={() => onDeleteSeason(season)} className="p-1.5 text-zinc-500 hover:bg-red-50 rounded-md dark:hover:bg-red-900/50"><Trash2 className="w-4 h-4"/></button>
                                                </div>
                                            </>
                                        )}
                                    </div>
                            ...
                            <div className="p-3 bg-zinc-50 dark:bg-zinc-950 flex gap-2">
                                <input value={newSeasonInput} onChange={e => setNewSeasonInput(e.target.value)} placeholder="Nueva (Ej: 2026-2027)" className="flex-1 text-sm px-3 py-1.5 border rounded dark:bg-zinc-900 dark:border-zinc-800 dark:text-white outline-none focus:border-emerald-500" />
                        ...
                        <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden">
                            <div className="max-h-48 overflow-y-auto p-2 space-y-2">
                                {checklistConfig.map(item => (
                                    <div key={item.id} className="flex items-center justify-between p-2 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-md">
                                        <div className="flex flex-col"><span className="text-sm font-bold dark:text-white">{item.label}</span><span className="text-[10px] uppercase font-bold text-zinc-500">{item.type === 'global' ? '🌍 Para siempre' : item.type === 'seasonal' ? '🔄 Renovable' : '📜 Contrato'}</span></div>
                            ...
                            <div className="p-3 bg-zinc-50 dark:bg-zinc-950 flex flex-col gap-2 border-t dark:border-zinc-800">
                                <div className="flex flex-col sm:flex-row gap-2">
                                    <input value={newChecklistLabel} onChange={e => setNewChecklistLabel(e.target.value)} placeholder="Ej: Logo..." className="flex-1 text-sm px-3 py-1.5 border rounded w-full dark:bg-zinc-900 dark:border-zinc-800 dark:text-white outline-none focus:border-emerald-500" />
                                    <select value={newChecklistType} onChange={e => setNewChecklistType(e.target.value)} className="text-sm sm:text-xs px-2 py-1.5 sm:py-0 border rounded w-full sm:w-auto bg-white dark:bg-zinc-900 dark:border-zinc-800 dark:text-white outline-none focus:border-emerald-500">
